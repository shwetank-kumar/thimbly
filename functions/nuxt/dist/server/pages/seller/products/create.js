...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/seller/products/create.vue?vue&type=template&id=b7ad37c8&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<h2 class=\"text-center\" data-v-b7ad37c8>New listing</h2> "),_c('v-card',{staticClass:"my-2 rounded-lg",attrs:{"outlined":""}},[_c('v-card-title',[_vm._v("Photos")]),_vm._v(" "),_c('product-photos'),_vm._v(" "),_c('v-card-actions',[_c('photo-actions')],1)],1),_vm._ssrNode(" "),_c('v-card',{staticClass:"my-2 rounded-lg",attrs:{"outlined":""}},[_c('v-card-title',[_vm._v(" Product Details ")]),_vm._v(" "),_c('product-details-form')],1),_vm._ssrNode(" "),_c('v-card',{staticClass:"my-2 rounded-lg",attrs:{"outlined":""}},[_c('v-card-title',[_vm._v(" Shipping Details ")]),_vm._v(" "),_c('shipping-options')],1),_vm._ssrNode(" "),_c('v-card',{staticClass:"my-2 rounded-lg",attrs:{"outlined":""}},[_c('v-card-title',[_vm._v(" Payment Options (Placeholder)")]),_vm._v(" "),_c('payment-options-seller')],1),_vm._ssrNode(" "),_c('v-row',{staticClass:"justify-space-around mx-2 my-5"},[_c('v-btn',{attrs:{"depressed":"","color":"error"},on:{"click":_vm.cancel}},[_vm._v("Cancel")]),_vm._v(" "),_c('v-btn',{attrs:{"depressed":"","disabled":!_vm.previewEnabled,"color":"primary"},on:{"click":_vm.publish}},[_vm._v("Publish")])],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/seller/products/create.vue?vue&type=template&id=b7ad37c8&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/seller/products/create.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var createvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async publish() {
      ...
      for (var idx = 0; idx < this.$store.state.productDetails.productPhotos.length; idx++) {
        var fname = Object(external_uuid_["v4"])();
        var fileRef = firebase["c" /* fireStorage */].child('images/' + fname);
        let blob = await fetch(this.$store.state.productDetails.productPhotos[idx]).then(r => r.blob());
...
// CONCATENATED MODULE: ./pages/seller/products/create.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/seller/products/create.vue
